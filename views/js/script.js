...
function validarMensaje(){
	...
	if(nombre != ""){
		...
		if(!expresion.test(nombre)){
			$("#nombre").after('<div class="alert alert-warning">No numbers or special characters are allowed.</div>');
			return false;
		}		
	}
	else if(mensaje != ""){
			...
			if(!expresion.test(mensaje)){
				$("#nombre").after('<div class="alert alert-warning">Special characters are not allowed.</div>');
				return false;
			}
		}
